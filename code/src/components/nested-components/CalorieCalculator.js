...
const requestOptions = {
    method: 'GET',
    headers: {
        'X-RapidAPI-Key': 'a5a0870405msh894627c2d4e106ep17d637jsn78da4fb10eea'
    }
};
...
const getCalorieCalculatorApiRequestUrl = (data) => {
    return `https://fitness-calculator.p.rapidapi.com/dailycalorie?rapidapi-key=a5a0870405msh894627c2d4e106ep17d637jsn78da4fb10eea&age=${data.age}&gender=${data.gender}&height=${data.height}&weight=${data.weight}&activitylevel=${data.activityLevel}`
}
