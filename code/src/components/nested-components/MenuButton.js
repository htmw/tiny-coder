...
const Button = ({ isMenuOpened, setIsMenuOpened }) => {
    ...
    return(
        <div className="menu-button" onClick={() => setIsMenuOpened(!isMenuOpened)}>
            <div backgroundColor="#ffffff" className="dash-2 dash" style={{ animationName: dashTwoAnimation }}></div>
            <div backgroundColor="#ffffff" className="dash-1 dash"></div>
            <div backgroundColor="#ffffff" className="dash-3 dash" style={{ animationName: dashThreeAnimation}}></div>
        </div>
    )
}
