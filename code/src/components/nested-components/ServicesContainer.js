...
const SERVICE_ALT = "Redefine-me Services";

const Services = () => {
    return (
        <div className="services-container">
            <Service
                description="Find the best meal for you and its recipes from Re-Define Me list of recommended meals or search for a recipe of your choice."
                path="Recipes"
                text="Find a Recipe"
