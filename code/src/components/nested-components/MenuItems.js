...
const MenuItems = ({ setIsMenuOpened}) => {
  ...
  return (
      <>
          ...
          <Link to="Gynamstic" onClick={handleMenuItemClick}>Coaches</Link>
          <Link to="Health-Care" onClick={handleMenuItemClick}>Experts</Link>
          <Link to="Recipes" onClick={handleMenuItemClick}>Recipes</Link>
          {/* <Link to="Meal-planning" onClick={handleMenuItemClick}>Food & Diet</Link> */}
